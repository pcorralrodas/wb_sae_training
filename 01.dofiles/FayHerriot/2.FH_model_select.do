...
global oput  	 "~\GitHub\GSS_Povmap\Data FH"
...
//*********************************************************************************************//
	...
	graph export "\SAE Ghana 2017\3. Graphics\Fig1_left.png", as(png) replace
	...
	graph export "\SAE Ghana 2017\3. Graphics\Fig1_right.png", as(png) replace
