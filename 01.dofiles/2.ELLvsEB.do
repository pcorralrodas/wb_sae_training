...
twoway (line xb_ptile sh_pop, lpattern(dash)) (line xb_eta_ptile sh_pop, lpattern(dash)) (line Y_B_ptile sh_pop, lpattern(dash)), yline(${lnpline}) xtitle(Cumulative share of population) ytitle(Welfare value (nat. log))
